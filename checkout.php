...
if(isset($_GET['cid'])){
    ...
    $query = "SELECT * FROM tbl_lesson where course_id = '$c_id'";
    ...
    $query1 = "SELECT * FROM tbl_course where course_id = '$c_id'";
...
<html lang="en">
<head>
	<title>ischool Payment Method</title>
	<meta charset="utf-8">
...
<body>
	<div class="modal">
      ...
      <div class="input_container">
					...
					<input class="input_field" name="txtstd" type="text" readonly value="<?php echo $_SESSION['myemail']?>">
				</div>
				<div class="input_container">
					<label class="input_label">Course name</label>
					<input class="input_field" readonly name="txtcourse" type="text" value="<?php echo $cname ?>">
				</div>
               <div class="input_container">
					<label class="input_label">Price :</label>
					<input class="input_field" readonly name="txtprice" type="number" value="<?php echo $cprice ?>">
				</div>
				<div class="input_container">
					<label class="input_label">Card Number</label>
					<input class="input_field" name="txtcard" type="number" placeholder="0000 0000 0000 0000">
				</div>
				<div class="input_container">
					<label class="input_label">Date / CVV</label>
					<div class="split">
						<input class="input_field" name="txtdate" style="width: 250px;" type="date" placeholder="01/23">
						<input class="input_field" name="txtcvv" style="width: 110px;" type="number" type="password" placeholder="CVV">
					</div>
				</div>
			</div>
			<button class="checkout" name="btninsert" type="submit" style="cursor: pointer;">
				<span>Checkout</span>
			</button>
		</form>
	</div>
...
if(isset($_POST['btninsert'])){
  ...
  $query = "INSERT INTO `tbl_order`( `course_name`, `std_email`, `order_date`, `order_amount`, `card_number`, `cvv`) VALUES ('$course','$std',$date,$price,$card,$cvv)";
