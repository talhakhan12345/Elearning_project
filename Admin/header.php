...
<header class="navbar navbar-dark sticky-top bg-primary flex-md-nowrap p-0 shadow" style="height:70px;">
  ...
  <div class="dropdown px-3">
      <a href="#" class="d-flex align-items-center link-body-emphasis text-decoration-none dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
        <img src="talha.png.png" alt="" width="32" height="32" class="rounded-circle me-2">
    ...
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
      <div class="position-sticky pt-3">
        <ul class="nav flex-column">
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="adminfirst.php">
          ...
          <li class="nav-item">
            ...
            <i class="fa-solid fa-person-chalkboard fs-4"></i>
              Lessons
            </a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
           ...
           <li class="nav-item">
            <a class="nav-link" href="changepwdadmin.php">
